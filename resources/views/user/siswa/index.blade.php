                  ...
                  <div class="tab-pane fade" id="bordered-justified-data-alamat" role="tabpanel" aria-labelledby="data-alamat-tab">
                    <form  class="row g-3" action="{{route('user.siswa.updateDataAlamat',$siswa->id)}}" method="post">
                      ...
                      <div class="col-12">
                        ...
                        <input id="koordinat" type="text" class="form-control {{$errors->has('koordinat_alamat') ? 'is-invalid' : ''}}" name="koordinat_alamat" value="{{ old('koordinat_alamat') ?: $siswa->koordinat_alamat }}" placeholder="Contoh penulisan -5.15078,119.452467">
